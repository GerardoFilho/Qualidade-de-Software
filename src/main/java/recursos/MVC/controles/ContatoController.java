...
public class ContatoController {
    ...
    public void adicionar(Contato contato) {
        ...
        String nomeTabela = Utils.relativeNomeClasse(contato.getClass().getName()).toLowerCase();
		...
		List<Field> f = r.getAtributos(contato);
		...
		for (Field fi : f) {
		    ...
		    try {
		        ...
		        if (!isId) {
		            ...
		            valores.add(String.valueOf(fi.get(contato)));
		        }
