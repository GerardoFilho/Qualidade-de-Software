...
public class Persistencia {
    Connection conn;
    public ArrayList<Tabela> tabelas = new ArrayList<>();
                ...
                for (Tabela tbRl : arL) {
                    ...
                    try {
                        ...
                        while (rstTabRel.next()) {
							...
							ArrayList<Object> todasLinhas = t1.getLinhas();
							
							Object oSaida = null;
							
							for (Object o3 : todasLinhas) {
							    ...
							    for(Field field1 : clazz.getDeclaredFields()) {
							        String nomeAtt1 = field1.getName();
							        if (nomeAtt1.contains("id_")) {
							            try {
							                field1.setAccessible(true);
							                String valorId = String.valueOf( field1.get(o3) );
							
							                if (valorId.equals(valorT1)){
							                    oSaida = o3;
							                    break;
							                }
                            ...
                            Object o1 = oSaida;
							ArrayList<Object> todasLinhas1 = t2.getLinhas();
							
							Object oSaida1 = null;
							
							for (Object o4 : todasLinhas1) {
							
							    if (oSaida1 != null){
							        break;
							    }
							
							    Class<?> clazz = o4.getClass();
							
							    for(Field field2 : clazz.getDeclaredFields()) {
							        String nomeAtt2 = field2.getName();
							        if (nomeAtt2.contains("id_")) {
							            try {
							                field2.setAccessible(true);
							                String valorId = String.valueOf( field2.get(o4) );
							
							                if (valorId.equals(valorT2)){
							                    oSaida1 = o4;
							                    break;
							                }
     ...
     */
    public void genericInsert(String tabela, ArrayList<String> colunas, ArrayList<String> valores) {
     ...
     */
    public <T> List<Field> getAtributos(T clazz) {
    ...
    public static class Utils {
        ...
        public static String relativeNomeClasse(String nm) {
            String str = nm.substring(nm.lastIndexOf(".") + 1);
            return str;
        }

        public static String convertAnotation(Annotation[] annotations) {
            StringJoiner sj = new StringJoiner(" ");
